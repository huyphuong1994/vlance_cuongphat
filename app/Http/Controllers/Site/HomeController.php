...
class HomeController extends Controller
{
    ...
    public function settingsData($page): array
    {
        ...
        $settings = [
            ...
            'bg_submenu'                        => settingHelper('bg_submenu') != [] && @is_file_exists(settingHelper('bg_submenu')['original_image']) ?  get_media(@settingHelper('bg_submenu')['original_image'], @settingHelper('bg_submenu')['storage']) : static_asset('images/default/bg.svg'),
            ...
            'show_categories_section'           => settingHelper('show_categories_section'),
