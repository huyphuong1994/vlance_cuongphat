...
class ProductController extends Controller
{
    ...
    public function productDetails(Request $request, $slug, ColorInterface $color, AttributeInterface $attribute): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            $product->makeHidden([
                'images', 'image_ids',  'thumbnail', 'thumbnail_id', 'meta_image', 'meta_image_id',
            ...
            if ($seller) :
                ...
                $product->seller            = [
                    ...
                    'phone'                 => '+' . $seller->country->phonecode . $seller->phone_no,
                    ...
                    'rating_count'          => (float)$seller->rating_count,
    ...
    ) : \Illuminate\Http\JsonResponse
    {
        try {
            $page = [];
            if ($request->route == 'component') {
                $type = 'product';
            } else if ($request->route == 'product.by.category' || $request->route == 'product.by.gadget') {
                $type = 'category';
