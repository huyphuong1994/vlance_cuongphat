        ...
        if ($request->contents):
            foreach ($request->contents as $key => $content):
                ...
                elseif ($content == 'category_section'):
                    ...
                    $type               = $requested_content . '_type';
                    $bg                 = $requested_content . '_bg';
                    $title_color        = $requested_content . '_title_color';
                    $title_active_color = $requested_content . '_title_active_color';
                    $home_page_contents[$key]['category_section']['category']               = $request->$category;
                    $home_page_contents[$key]['category_section']['type']                   = $request->$type;
                    $home_page_contents[$key]['category_section']['bg']                     = $request->$bg;
                    $home_page_contents[$key]['category_section']['title_color']            = $request->$title_color;
                    $home_page_contents[$key]['category_section']['title_active_color']     = $request->$title_active_color;
                    $home_page_contents[$key]['category_section']['banner']['thumbnail']    = [];
                    $home_page_contents[$key]['category_section']['banner']['url']          = [];
                    $banner_thumbnail                                               = 'banner_thumbnail_' . $content_number;
                    $banner_url                                                     = 'banner_url_' . $content_number;
                    if($request->$banner_thumbnail && is_array($request->$banner_thumbnail)) {
                        foreach ($request->$banner_thumbnail as $url_key => $thumbnail):
                            $this->getImageWithRecommendedSize($thumbnail,'405','745',true);
                            $url = $request->$banner_url[$url_key];
                            array_push($home_page_contents[$key]['category_section']['banner']['thumbnail'], $thumbnail);
                            array_push($home_page_contents[$key]['category_section']['banner']['url'], $url);
                        endforeach;
                    } else {}
