...
class SellerProfile extends Model
{
    ...
    protected $fillable = [
        ...
        'shop_page_contents', 'meta_title', 'meta_description', 'verified_at','seller_country_id','affiliate_amount','affiliate_amount_type'
    ];
    ...
    public function country() {
        return $this->belongsTo(Country::class, 'seller_country_id', 'id');
    }
