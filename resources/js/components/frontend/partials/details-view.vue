  ...
  <div v-if="productDetails.id">
    ...
    <div class="row">
      <div class="col-lg-9 col-md-8">
        <div class="row">
          <div
              :class="{ 'col-lg-5 col-md-12': $route.name == 'product.details', 'col-lg-5': $route.name != 'product.details' }"
                ...
                <div class="product-details-2">
                  <div class="product-details-header">
                    ...
                    <div class="sg-rating" v-if="productDetails.rating > 0">
                      ...
                      <span class="rating"> ({{ productDetails.reviews_count }} {{
                          lang.reviews
                        }})</span>
                    </div>
                  </div>
...
export default {
  ...
  watch: {
    productDetails(value) {
      console.log('123', this.productDetails.id)
      if (this.productDetails && this.productDetails.form) {
        if (this.productDetails.special_discount_check > 0) {
          this.setCountDown();
        }
