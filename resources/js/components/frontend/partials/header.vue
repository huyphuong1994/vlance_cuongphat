        ...
        <div class="topbar-content">
              ...
              <li v-if="settings.language_switcher != 0">
                <div class="dropdown">
                  <button class="dropdown-toggle" type="button" @click.stop="languageDropdown"
                          ...
                          aria-expanded="false">{{ activeLanguage.name }}
                  </button>
              ...
              <li v-if="settings.currency_switcher != 0">
                <div class="dropdown">
                  <button class="dropdown-toggle" type="button" id="" @click.stop="currencyDropdown"
                          ...
                          aria-expanded="false">{{ activeCurrency.name }}
                  </button>
                  <ul @click.stop class="dropdown-menu" :class="{ show: currency_dropdown }"
                      aria-labelledby="">
                    <li v-for="(currency, index) in currencies" :key="index"><a
                        class="dropdown-item" @click="changeCurrency(currency)"
          ...
          <div class="right-content new-list">
            <ul class="global-list">
              ...
              <li>
                <router-link :class="{ has_compare: compareList > 0 }" :to="{ name: '' }">
                  {{ lang.support }}
                </router-link>
              </li>
              <li>
                <router-link :class="{ has_compare: compareList > 0 }" :to="{ name: 'register' }">
                  {{ lang.Signup }}
                </router-link>
              </li>
              <!--              <li>-->
            ...
            <ul class="global-list user-shop-option">
                      ...
                      <div class="sg-product" v-if="!cart.is_buy_now">
                        ...
                        <div class="product-thumb">
                          <router-link
                            ...
                            <img loading="lazy" :src="cart.image_40x40"
                                 :alt="cart.product_name" class="img-fluid"/></router-link>
                        </div>
                        <div class="product-info text-ellipse text-ellipse-two">
                          <h3 class="text-ellipse text-ellipse-two">
                            <router-link
                                :to="{ name: 'product.details', params: { slug: cart.product_slug } }">
                              {{ cart.product_name }}
                            </router-link>
              ...
              <!-- <li class="compare-icon">
                <router-link :to="{ name: 'compare.list' }">
                  <div class="icon"><img :src="getUrl('public/images/others/compare.svg')"
                      alt="List" /></div>
                  ...
                  <div class="col-md-8">
                    <div class="products-details-info">
                      ...
                      <div class="stock-delivery">
                        <shimmer class="de-margin" v-for="(list, i) in 2" :key="i"
                                 :height="100"></shimmer>
                      </div>
                      <div class="row">
