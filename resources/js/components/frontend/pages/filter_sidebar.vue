<template>
	<div class="sg-page-content">
		<section class="grid-view-tab">
			<div class="sg-breadcrumb" v-if="page && page.title">
				<div class="container">
					<ol class="breadcrumb">
				...
				<div class="row sg-category-content sg-filter grid-view-tab" :class="activeClass">
					<div class="col-md-4 col-lg-3 filter_area" v-if="lengthCounter(productList) > 0">
						<div class="sg-sitebar new-shop-sitebar">
							<div class="accordion" id="shop_sidebar_accordion">
									...
									<div id="category" class="accordion-collapse collapse" :class="{ show: category }"
										...
										<div class="accordion-body">
											...
											<div v-if="category_load_more || categories.next_page_url">
												<a @click="loadCategories" href="javaScript:void(0)">{{ lang.show_more }}</a>
											</div>
										</div>
									</div>
								</div>
								...
								<!-- Colors -->
								<div class="accordion-item" v-if="settings.color == 1 && colors.data && colors.data.length">
									...
									<div id="collapse5" class="accordion-collapse collapse show" :class="{ show: color }"
										aria-labelledby="ac5">
										<div class="accordion-body">
											<form action="#" class="form-checkbox">
					...
					<div class="col-md-8 col-lg-9">
						<div class="sg-category-content sg-filter" :class="activeClass">
							<!-- <div class="cta mb-4" v-if="page && page.image_835x200">
								<div v-if="page.image_835x200 == getUrl('images/default/default-image-835x200.png')">
									<a v-if="settings.category_default_banner != null">
										<img loading="lazy"
											:src="settings.category_default_banner" :alt="form.slug"
											class="img-fluid" />
									</a>
									<a v-else>
										<img loading="lazy" :src="page.image_835x200" :alt="form.slug"
											class="img-fluid" />
									</a>
								</div>
								<div v-else>
									<a v-if="page.image_835x200">
										<img loading="lazy" :src="page.image_835x200"
											:alt="form.slug" class="img-fluid" />
									</a>
								</div>
							</div> -->
						...
						<product :products="productList" :number="8" :grid_class="'grid-6'"></product>
