                                        ...
                                        <select class="form-control select2" id="code" name="currency_code"
                                            ...
                                            @if (count($currency_list) > 0)
                                                @foreach ($currency_list as $key => $value)
                                                    <option
                                                        {{ isset($user) && $user->currency_code == $key ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group sohide_ico_pos" id="show_hide_password">
                                        <input type="password" id="password" name="password" class="form-control"
                                            placeholder="{{ __('Password') }}" {{ isset($user) ? '' : 'required' }}">
                            ...
                            <div class="card-body card-body-paddding">
                                ...
                                <div class="form-group">
                                    @include('admin.partials.tel-input', [
                                        ...
                                        'value' =>
                                            old('phone_no') ?:
                                            (isset($user) && $user->sellerProfile
                                                ? $user->sellerProfile->phone_no
                                                : ''),
                                        'label' => __('Phone'),
                                        'class' => 'form-control',
                                        'id' => 'txtPhone',
                                        ...
                                        'country_id' =>
                                            old('seller_country_id') ?:
                                            (isset($user) && $user->sellerProfile
                                                ? $user->sellerProfile->seller_country_id
                                                : settingHelper('default_country')),
                                    ])
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="file" id="shop_logo"
                                            ...
                                            name="logo" id="customFile" value="" accept="image/*" />
                                    </div>
                                ...
                                <div class="form-group seo-image-positoin">
                                    ...
                                    <div class="form-group">
                                        <input type="file" id="shop_banner"
                                            ...
                                            name="banner" value="{{ @$user->image_id }}" accept="image/*" />
                                    </div>
                                    <div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                            ...
                                            <span class="form-control"><span
                                                    class="counter">{{ old('shop_banner') != '' ? substr_count(old('shop_banner'), ',') + 1 : (@$user->sellerProfile->shop_banner_id != '' ? substr_count(@$user->sellerProfile->shop_banner_id, ',') + 1 : 0) }}</span>
                                                {{ __('file chosen') }}</span>
