                            ...
                            <div class="card">
                                ...
                                <div class="card-body col-md-10 middle">
                                    <form method="post" action="{{route('update')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group seo-image-positoin">
                                            <label for="bg_submenu">{{ __('Submenu Background') }}</label>
                                            <div class="form-group">
                                                <input type="file" id="bg_submenu" class="custom-file-input image_pick file-select" accept="image/*" data-image-for="bg_submenu" name="bg_submenu" id="customFile" value="{{ @$user->image_id }}" />
                                            </div>
                                            <div>
                                                @if(@settingHelper('bg_submenu') != [] && is_file_exists(@settingHelper('bg_submenu')['image_138x52']))
                                                    <img src="{{ static_asset(@settingHelper('bg_submenu')['image_138x52'])}}" alt="" id="img_bg_submenu" class="img-thumbnail site-icon" />
                                                @else
                                                    <img src="{{ static_asset('images/default/default-image-72x72.png') }}" alt="{{ @$user->first_name }}" id="img_bg_submenu" class="img-thumbnail site-icon" />
                                                @endif
                                            </div>
                                        </div>
