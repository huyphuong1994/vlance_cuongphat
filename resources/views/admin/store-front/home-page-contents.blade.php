            ...
            <div class="card-body mobile_banner banner-{{ $content_count }}">
                <div class="alert alert-light alert-has-icon p-0">
                    ...
                    <div class="alert-body">
                        @php
                            $banner_contents = @$contents ? $contents['banner'] : [];
                        @endphp
                ...
                @if(isset($contents))
                    @foreach($banner_contents['thumbnail'] as $key => $thumbnail)
                                                    ...
                                                    <div class="row mt-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <select class="form-control selectric action_type"
                                                                        ...
                                                                        <option value="product" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'product' ? 'selected' : '' }}>{{__('Product')}}</option>
                                                                        <option value="category" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'category' ? 'selected' : '' }}>{{__('Category')}}</option>
                                                                        <option value="brand" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'brand' ? 'selected' : '' }}>{{__('Brand')}}</option>
                                                                        @if(settingHelper('seller_system') == 1)
                                                                            <option value="seller" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'seller' ? 'selected' : '' }}>{{__('Seller')}}</option>
                                                                        @endif
                                                                        <option value="blog" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'blog' ? 'selected' : '' }}>{{__('Blog')}}</option>
                                                                        {{--                                                                        <option value="url" {{ isset($banner_contents['action_type'][$key]) && $banner_contents['action_type'][$key] == 'url' ? 'selected' : '' }}>{{__('URL')}}</option>--}}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="productDiv" id="product_{{ $content_count }}"
                                                                 style="{{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'product' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="product-by-ajax product-by-ajax form-control select2"
                                                                            ...
                                                                            aria-hidden="true">
                                                                        @if(arrayCheck('action_to',$banner_contents) && arrayCheck($key,$banner_contents['action_to'][$key]))
                                                                            @php
                                                                                $product = \App\Models\Product::find($banner_contents['action_to'][$key][$key]);
                                                                            @endphp
                                                                            @if($product)
                                                            ...
                                                            <div class="categoryDiv" id="category_{{ $content_count }}"
                                                                 style="
                                                            {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'category' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select class="filter-categories-by-ajax form-control"
                                                                        ...
                                                                        @if(arrayCheck('action_to',$banner_contents) && arrayCheck($key,$banner_contents['action_to'][$key]))
                                                                            @php
                                                                                $category = \App\Models\Category::find($banner_contents['action_to'][$key][$key]);
                                                                            @endphp
                                                                            @if($category)
                                                            ...
                                                            {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'blog' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select class="filter-blogs-by-ajax form-control"
                                                                        ...
                                                                        @if(arrayCheck('action_to',$banner_contents) && arrayCheck($key,$banner_contents['action_to'][$key]))
                                                                            @php
                                                                                $blog = \App\Models\Blog::find($banner_contents['action_to'][$key][$key]);
                                                                            @endphp
                                                            ...
                                                            <div class="brandDiv" id="brand_{{ $content_count }}" style="{{
                                                                        arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'brand' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select class="form-control select2"
                                                                        ...
                                                                        @foreach($brands as $brand)
                                                                            <option
                                                                                    value="{{ $brand->id }}" {{ arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'brand' && $brand->id == $banner_contents['action_to'][$key][$key] ? 'selected' : '' }}>{{ $brand->getTranslation('title', App::getLocale()) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            @if(settingHelper('seller_system') == 1)
                                                                <div class="sellerDiv" id="seller_{{ $content_count }}"
                                                                     style="{{
                                                                            arrayCheck('action_type',$banner_contents) && arrayCheck($key,$banner_contents['action_type']) && $banner_contents['action_type'][$key] == 'seller' ? '' : 'display:none' }}">
                                                                    <div class="form-group">
                                                                        <label>{{ __('Action To') }}</label>
                                                                        <select class="seller-by-ajax form-control select2"
                                                                            ...
                                                                            @if(arrayCheck('action_to',$banner_contents) && arrayCheck($key,$banner_contents['action_to'][$key]))
                                                                                @php
                                                                                    $seller = \App\Models\SellerProfile::find($banner_contents['action_to'][$key][$key]);
                                                                                @endphp
                                                                                @if($seller)
...
{{--                            </option>--}}
                ...
                <div class="form-group banner-{{ $content_count }}">
                    <div class="alert alert-light alert-has-icon p-0">
                        <div class="alert-icon pl-2"><i class="bx bx-bulb"></i></div>
                        <div class="alert-body">
                            @php
                                $banner_contents = @$contents ? $contents['category_section']['banner'] : [];
                            @endphp
                            <div class="form-text">{{ __('Recommended banner ratio 16:9') }}</div>
                        </div>
                    </div>
                    @if(isset($contents) && isset($banner_contents['thumbnail']))
                        @foreach($banner_contents['thumbnail'] as $key => $thumbnail)
                            <div class="banner-item mb-2">
                                <div class="item row">
                                    <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="javaScript:void(0)"
                           class="btn btn-outline-secondary add-home-content"
                           data-type="banner-image" data-area="banner-{{ $content_count }}"
                           data-content="{{ $content_count }}"
                           class="btn btn-outline-primary"><i class="bx bx-plus"></i> {{ __('Add Banner') }}</a>
                    </div>
                </div>
            </div>
        </div>
