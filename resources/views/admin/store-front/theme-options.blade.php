                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="fonts" name="fonts" class="form-control selectric">
                                                ...
                                                <option value="Quicksand"
                                                    @if(old('fonts') ? old('fonts') : settingHelper('fonts') == 'Quicksand') selected @endif>{{ __('Quicksand') }}</option>
                                                <option value="Manrope"
                                                    @if(old('fonts') ? old('fonts') : settingHelper('fonts') == 'Manrope') selected @endif>{{ __('Manrope') }}</option>
                                            </select>
                                        </div>
