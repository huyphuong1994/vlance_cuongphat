            ...
            @if(addon_is_activated('seller_subscription'))
                <li class="nav-item dropdown @yield('seller_subscription')">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="@yield('online_subscriptions')"><a class="nav-link" href="{{ route('online.purchase.history') }}">{{ __('online_purchase_history') }}</a></li>
                        @if(addon_is_activated('offline_payment'))
                            <li class="@yield('offline_subscriptions')"><a class="nav-link" href="{{ route('offline.purchase.history') }}">{{ __('offline_purchase_history') }}</a></li>
                        @endif
                    </ul>
                </li>
            @endif
