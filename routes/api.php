...
//Route::post('set-slug-auto-product', [ProductController::class, 'setSlugAutoProduct']);
//Route::post('set-slug-auto-category', [CategoryController::class, 'setSlugAutoCategory']);
